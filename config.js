...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || '13_1_3433_3935_40a6').trim(),
  DATABASE:
  ...
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'n',
  ...
  ANTILINK_MSG: process.env.ANTILINK_MSG || '_Antilink Detected &mention warn_',
  ANTISPAM_MSG: process.env.ANTISPAM_MSG || '_Antispam Detected &mention warn_',
  ...
  ANTI_BOT_MESSAGE: process.env.ANTI_BOT_MESSAGE || '&mention warn',
  WARN_MESSAGE:
